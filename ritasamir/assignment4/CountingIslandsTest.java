...
public class CountingIslandsTest {
	...
	public void testGetNumberOfIslands() {
		...
		assertEquals(count.getNumberOfIslands(tiles_1, 4, 4), 3);
		boolean[][] tiles_2 = { { false, true, false }, { true, true, false },
				{ false, false, true }, { false, false, true } };
		assertEquals(count.getNumberOfIslands(tiles_2, 4, 3), 2);
	}

	@Test
	public void testNoIslands() {
		boolean[][] tiles = new boolean[3][2];
		assertEquals(count.getNumberOfIslands(tiles, 3, 2), 0);
	}

	@Test(expected = Error.class)
	public void testWrongSize() {
		boolean[][] tiles = new boolean[3][2];
		count.getNumberOfIslands(tiles, -1, 3);
	}
