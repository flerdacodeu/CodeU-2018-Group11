...
/**
 * Grid of booleans representing a map. True elements in the grid represent land
 * whereas false tiles represent water.
 * 
 * @author Sephora-M
 */
public class Map {
	 ...
	 * 
	 * @param map,
	 *            2d array of boolean, represent the final map
	 */
	 ...
	 * The algorithm finds islands by looking at each tiles iteratively and if they are land tiles it searches all its adjacent land tiles in a DFS manner
	 * while marking them as visited such that they are skipped in further iterations.
	 * @return an int, number of islands found
	 */
	...
	ArrayList<Point> findNeighbors(Point p, boolean[][] depthMap) {
