...
public class Anagrams {
	 ...
	 * @param caseSensitive boolean, if true, checks if str1 and str2 are case sensitive anagram of each other,
	 * otherwise cheks if they are case insensitive anagrams
